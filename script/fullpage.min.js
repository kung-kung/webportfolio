...
! function (n, t) {
    ...
    var vn = {
            ...
            D: function (n, t) {
                var e = this;
                return "object" !== sn(this.L[n]) && (this.L[n] = []), this.L[n].push(t),
                    function () {
    ...
    function zt(n) {
        var t, e, i = Tt();
        return i.autoScrolling && !i.scrollBar ? (t = -n, e = p(Hn)[0]) : (t = n, e = window), {
            options: t,
            element: e
        }
    }
    ...
    function Vt(n) {
        ...
        else if (Tt().autoScrolling && !Tt().scrollBar) y(St(), {
            top: -t + "px"
        }), f.test.top = -t + "px";
        else {
            var e = zt(t);
    ...
    function Yt(n, t, e, i) {
        ...
        hn({
            q: !0
        }), _t && window.cancelAnimationFrame(_t), _t = function (f) {
            r || (r = f);
            var s = Math.floor(f - r);
            if (dn.q) {
                var v = t;
                e && (v = o.fp_easings[Tt().easing](s, a, u, e)), s <= e && Ct(n, v), s < e ? window.requestAnimationFrame(_t) : void 0 === i || l || (i(), hn({
                    q: !1
                }), l = !0)
            } else l || c || (i(), hn({
                q: !1
    ...
    function oe(n, t, e) {
        var i = "";
        Tt().anchors.length && !Tt().lockAnchors && (n ? (null != e && (i = e), null == t && (t = n), hn({
            K: t
        }), re(i + "/" + t)) : null != n ? (hn({
            K: t
        }), re(e)) : re(e)), ee()
    ...
    le.m = {
        ...
        left: !0,
        right: !0
    }, le.k = g({}, le.m), vn.D(mn, (function (n) {
        var t = n.target;
    ...
    function je(n, t, e) {
        ...
        if (null != i) {
            var o, r, a = function (n) {
                    ...
                    return t > w() ? (o || a) && "bottom" !== a || (i = r) : (o || dn.V && null == T(n)) && (i = r), hn({
                        tn: i
                    }), i
                }(i),
                u = {
            ...
            if (!(pn().I.item == i && !dn.V || Tt().scrollBar && H() === u.dtop && !m(i, "fp-auto-height"))) {
                ...
                Tt().autoScrolling && Tt().continuousVertical && void 0 !== u.isMovementUp && (!u.isMovementUp && "up" == u.yMovement || u.isMovementUp && "down" == u.yMovement) && (u = function (n) {
                        ...
                        var t = pn().I.item;
                        return n.isMovementUp ? N(t, tn(t, $n)) : I(t, en(t, $n).reverse()), Vt(pn().I.item.offsetTop),
                            function () {
                                for (var n = p(nt), t = 0; t < n.length; t++) Ge(n[t], "internal")
                            }(), n.mn = t, n.dtop = n.element.offsetTop, n.yMovement = Nt(pn().I, n.element), n
                    }(u)), u.localIsResizing || ne(pn().I.item), L(i, Kn), D(W(i), Kn), Qe(), te(i), hn({
                        G: f.test.wn
                    }), oe(r, o, u.anchorLink), vn.R(Pn, u),
                    function (n) {
    ...
    function Oe(n) {
        hn({
            ...
            }(n), Y(Tt().afterLoad) && !n.localIsResizing && Xt("afterLoad", n), Qe(), n.localIsResizing || Jt(n.element), L(n.element, Gn), D(W(n.element), Gn), he(), hn({
                G: !0
            }), vn.R(Fn, n), Y(n.callback) && n.callback()
    }
    ...
    function Ie(n) {
        var t = n.item,
            e = n.Sn.length,
            i = n.index();
        !pn().I && n.isVisible && (L(t, Kn), Qe(), Ce = pn().I.item), Tt().paddingTop && y(t, {
        ...
        }), void 0 !== Tt().anchors[i] && t.setAttribute("data-anchor", n.anchor), e || Fe(n)
    }
    ...
    var He, We, Ve = {
        ...
        zn: function (n) {
            Ve.Pn(n).addEventListener("scroll", Ve.Cn), n.addEventListener("wheel", Ve.Dn, {
                passive: !1
            }), n.addEventListener("keydown", Ve.En, {
                passive: !1
            })
        },
        Fn: function (n) {
        ...
        Cn: (He = 0, function (n) {
            ...
            He = t, Y(Tt().onScrollOverflow) && Xt("onScrollOverflow", {
                position: t,
                direction: e
            }), m(n.target, at) && dn.G && Ve.Nn(e, n.target) && Ve.Bn() && Ve.bn(pn().I.item) && vn.R(An, {
                direction: e
            })
        })
    };
    ...
    function _e(n, t, e) {
        ...
        l.Hn = (i = l.prevSlideIndex, o = l.slideIndex, i == o ? "none" : i > o ? "left" : "right"), l.direction = l.direction ? l.direction : l.Hn, l.localIsResizing || hn({
            G: !1
        }), Tt().onSlideLeave && !l.localIsResizing && "none" !== l.Hn && Y(Tt().onSlideLeave) && !1 === Xt("onSlideLeave", l) ? hn({
            W: !1
        }) : (L(t, Kn), D(W(t), Kn), Qe(), l.localIsResizing || (ne(l.prevSlide), te(t)), function (n) {
            ...
            if (i = t.slidesNav, o = t.slideIndex, Tt().slidesNavigation && null != i && (D(p(qn, i), Kn), L(p("a", p("li", i)[o]), Kn)), hn({
    ...
    function qe(n) {
        n.localIsResizing || (Y(Tt().afterSlideLoad) && Xt("afterSlideLoad", n), hn({
            G: !0
        }), Jt(n.destiny), vn.R(zn, n)), hn({
            W: !1
        })
    }

    function Ge(n, t) {
        Ut(0, "internal"), void 0 !== t && hn({
            V: !0
        }), _e(C(n, et), n), void 0 !== t && hn({
            V: !1
    ...
    function oi(n) {
        ...
        y(p(ot, n.item), {
            ...
            I(p(et, t)[0], e), L(e, st), L(e[0], dt), L(e[1], "fp-next"), "#fff" !== Tt().controlArrowColor && (y(p(pt, t), {
    ...
    var ji, Oi, Li, Di, Ei = 0,
        Ri = 0,
        Pi = 0,
        Fi = 0,
        zi = (o.PointerEvent && (Di = {
            down: "pointerdown",
            move: "pointermove"
        }), Di),
        Ci = {
    ...
    function Ii(n) {
        ...
        if (Ni(n)) {
            ...
            var r = Math.abs(Ei - Pi) > o.innerHeight / 100 * Tt().touchSensitivity,
                ...
                l = Ei > Pi ? "down" : "up";
            hn({
                Y: u ? Ri > Fi ? "right" : "left" : l
            }), u ? !dn.W && a && (Ri > Fi ? fe().m.right && vn.R(bn, {
                section: t
            }) : fe().m.left && vn.R(wn, {
                section: t
    ...
    function uo(n) {
        var t = (new Date).getTime(),
            ...
            i = function (n, t) {
                (new Date).getTime();
                var e = pn().B && n.getBoundingClientRect().bottom >= 0 && "up" === hi.Kn(),
                    i = pn().qn;
                if (i) return V(t), !1;
                if (pn().B) {
                    if (e) {
                        var o;
                        if (!(i || Si("isNewKeyframe", "beyondFullpage") && hi._n())) return (o = zt(rn(pn().C).item.offsetTop + rn(pn().C).item.offsetHeight)).element.scrollTo(0, o.options), hn({
                            qn: !1
                        }), V(t), !1;
                        if (hi._n()) return e = !1, hn({
                            qn: !0
                        }), hn({
                            N: "wheel"
                        }), mi(), V(t), !1
        ...
        if (dn.Z || hn({
                ...
                Z: !0,
                Y: "none"
            }), !fe().m.down && !fe().m.up) return V(n), !1;
        if (i) return !0;
        if (!1 === i) return V(n), !1;
        if (Tt().autoScrolling && !ji && !e) {
            ...
            var f = t - oo;
            return oo = t, f > 200 && (ro = []), hn({
                X: c
            }), dn.G && an(ro, 10) >= an(ro, 70) && l && (hn({
                N: "wheel"
            }), ki(a < 0 ? "down" : "up")), !1
        }
        Tt().fitToSection && hn({
    ...
    function fo(n) {
        n ? (ao(!0), function () {
            if (Ci.Gn && (a || l)) {
                Tt().autoScrolling && (Kt.removeEventListener(Ci.Gn, Vi, {
                    passive: !1
                }), Kt.addEventListener(Ci.Gn, Vi, {
                    passive: !1
                }));
                var n = Tt().touchWrapper;
                n.removeEventListener(Ci.Yn, Bi), n.removeEventListener(Ci.Gn, Ii, {
                    passive: !1
                }), n.addEventListener(Ci.Yn, Bi), n.addEventListener(Ci.Gn, Ii, {
                    passive: !1
                })
            }
        }()) : (ao(!1), function () {
            if (Ci.Gn && (a || l)) {
                Tt().autoScrolling && (Kt.removeEventListener(Ci.Gn, Ii, {
                    passive: !1
                }), Kt.removeEventListener(Ci.Gn, Vi, {
                    passive: !1
                }));
                var n = Tt().touchWrapper;
                n.removeEventListener(Ci.Yn, Bi), n.removeEventListener(Ci.Gn, Ii, {
        ...
        So || (Tt().autoScrolling && !Tt().scrollBar || !Tt().fitToSection) && xo(w()),
            function () {
                if (a)
                    for (var n = 0; n < 4; n++) wo = setTimeout((function () {
                        window.requestAnimationFrame((function () {
                            Tt().autoScrolling && !Tt().scrollBar && (hn({
                                V: !0
                            }), go(dn.I.index() + 1), hn({
                                V: !1
                            }))
                ...
                ! function () {
                    if (hn({
                            V: !0
                        }), xo(""), Tt().autoScrolling || dn.B || function () {
    ...
    function Ao(n) {
        if (!m(St(), Un)) {
            ...
            dn.B || a && go(a + 1), hn({
                V: !1
            }), Y(Tt().afterResize) && n && Tt().afterResize.call(St(), o.innerWidth, o.innerHeight), Y(Tt().afterReBuild) && !n && Tt().afterReBuild.call(St()), $(St(), "afterRebuild")
        }
    }
    ...
    function Oo() {
        if (!dn.U && !Tt().lockAnchors) {
            ...
            t && t.length && (t && t !== dn._ && !i || o || !dn.W && dn.K != e) && vn.R(xn, {
                Xn: t,
                slideAnchor: e
            })
        }
    ...
    function Do(n) {
        hn({
            N: "menu"
        }), !p(Tt().menu)[0] || !Tt().lockAnchors && Tt().anchors.length || (V(n), vn.R(jn, {
    ...
    function zo(n) {
        ...
        if (!dn.V && pn().I && (rn(pn().C), !pn().B && !pn().qn && (!Tt().autoScrolling || Tt().scrollBar))) {
            ...
            if (i = u, o = pn().I.item.offsetTop, r = o + w(), ("up" == i ? r >= H() + w() : o <= H()) && (m(pn().I.item, Gn) || (L(pn().I.item, Gn), D(W(pn().I.item), Gn))), e = (t = s[l]).item, !t.isActive) {
                ...
                T && (h = T.anchor, d = T.index()), dn.G && (L(e, Kn), D(W(e), Kn), Y(Tt().beforeLeave) && ke("beforeLeave", M), Y(Tt().onLeave) && Xt("onLeave", M), Y(Tt().afterLoad) && Xt("afterLoad", M), ne(p), te(e), Jt(e), we(y, S - 1), Tt().anchors.length && hn({
                    _: y
                }), Qe(), oe(d, h, y)), clearTimeout(Ro), Ro = setTimeout((function () {
                    hn({
                        U: !1
                    })
                }), 100)
    ...
    function Wo() {
        Xe(), Qe(), Tt().scrollBar = Tt().scrollBar || Tt().hybrid, xt(),
            function () {
                y(ln(St(), "body"), {
                    height: "100%",
                    position: "relative"
    ...
    function Uo(n, t) {
        var e;
        if (Kt = p("body")[0], qt = p("html")[0], Gt = p("html, body"), !m(qt, _n)) return "touchWrapper", e = "string" == typeof n ? p(n)[0] : n, gt.touchWrapper = e,
            function (n) {
